...
- (void)segementBasicSetting {
    ...
    _segementHeight = 44.;
    _minItemSpace = 20.;
    _segementTintColor = [UIColor whiteColor];
...
- (void)segementPageSetting {
    ...
    _backView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, _size.width, _segementHeight)];
    ...
    for (int i = 0; i < _titles.count; i++) {
        ...
        if (i == 0) {
            ...
            [_backView addSubview:_indicateView];
        }
    }
