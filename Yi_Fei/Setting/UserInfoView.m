...
- (void)addViewConstraints {
    ...
    [self.logoImageView autoPinEdgeToSuperviewEdge:ALEdgeTop withInset:70];
    ...
    [self.nameLabel autoPinEdge:ALEdgeLeading toEdge:ALEdgeTrailing ofView:self.logoImageView withOffset:20];
    [self.nameLabel autoPinEdge:ALEdgeTop toEdge:ALEdgeTop ofView:self.logoImageView withOffset:50];
    ...
    [self.levelLabel autoPinEdge:ALEdgeTop toEdge:ALEdgeBottom ofView:self.nameLabel withOffset:5];
