...
@interface ManualAddAupplyController ()<UITextFieldDelegate,UITextViewDelegate,ThreeCellDelegate,SSPopupDelegate,SixCellDelegate,SevenDelegate>
{
    FirstCell  *firstCell;
...
@implementation ManualAddAupplyController
...
-(void)clickBtnNextController{
 ...
 _model.companyAddress = [address componentsJoinedByString:@"|"];
    ...
    SupplyList  *manager = [SupplyList defaultManager];
    //查询
