...
- (void)insertDataModel:(ProductionData *)model{
    ...
    NSString * insertSql = @"insert into addTwoYiFei(id,shopName,shopSize,shopMed,shopColor,shopPrice,shopHuoBi,shopTiaoK,shopAdderss,shopDescribe,shopInfo,shopCustom,shopContent,shopPicture) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
{
    NSString * isSql = @"select *from addTwoYiFei where id=?";
...
{
    NSString * deleteSql = @"delete from addTwoYiFei where id = ?";
