...
@interface BuyerEditProductController ()<UITableViewDelegate,UITableViewDataSource,UINavigationControllerDelegate,UIImagePickerControllerDelegate,UITextFieldDelegate,UITextViewDelegate,EditThreeShopCellDelegate,SSPopupDelegate,UITextFieldDelegate>{
...
@implementation BuyerEditProductController
