...
@interface AskWayController ()<SearchBarViewDelegate,XHSegmentControlDelegate, UITableViewDelegate, UITableViewDataSource,QueryPriceTableViewCellDelegate,DownSheetDelegate>{
    UIView *addTableV;
