...
@interface PreparePriceController ()<SecondViewCellDelegate,UWDatePickerViewDelegate,UITextFieldDelegate,UITextViewDelegate>
{
...
@implementation PreparePriceController
...
-(void)setDataFromeModel:(UITextField*)textFiled{
    ...
    if (_model.count.length != 0) {
       firstCell.textfFiled.text = _model.count;
    }else{
        firstCell.textfFiled.text = @"";
    }
        }
