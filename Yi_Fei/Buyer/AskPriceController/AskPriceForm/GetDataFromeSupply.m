...
@implementation GetDataFromeSupply


-(void)getDataFromeForm{
    
    SupplyOfferModel *model = [[SupplyOfferModel alloc] init];
    SupplyOfferList * manager = [SupplyOfferList defaultManager];
    
    NSString *path = [UserDefaultManager getDataByKey:@"keyPath"];
