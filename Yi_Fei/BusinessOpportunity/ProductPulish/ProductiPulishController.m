...
- (void)setNav {
    self.navigationItem.title = NSLocalizedString(@"productPulish", nil);
...
-(void)createScrollerView{
    ...
    PulishOneViewController *oneController = [[PulishOneViewController alloc] init];
    PulishTwoController *twoController = [[PulishTwoController alloc] init];
...
-(void)createButton{
    ...
    [_leftBtn setTitle:NSLocalizedString(@"mineCustomer", nil) forState:UIControlStateNormal];
