...
- (void)drawBottomItems
{
    ...
    _btnFlash.center = CGPointMake(CGRectGetWidth(_bottomItemsView.frame)* 0.75, CGRectGetHeight(_bottomItemsView.frame)/2);
...
{
        ScanCusomerController *vc = [ScanCusomerController new];
