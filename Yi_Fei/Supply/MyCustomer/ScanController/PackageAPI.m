...
{
    CGFloat date = [[NSDate date] timeIntervalSince1970]*1000;
    NSString *sTime = [[NSString alloc] initWithFormat:@"%f",date] ;
    NSLog(@"%@", sTime);
...
{
    NSString *upAction;
    NSString *username = @"c37e9605-a790-449d-a652-d7b93927fdb9";
    NSString *psd = @"uUryMrVaHjONkxEwfvxLJEgSyDARec";
