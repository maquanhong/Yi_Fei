...
- (void)addViewConstraints {
    ...
    _titleNineLabel  = [[UILabel alloc] init];
    _titleNineLabel.text = @"商品标本:";
    _titleNineLabel.font = [UIFont systemFontOfSize:14];
    [self addSubview:_titleNineLabel];
    [_titleNineLabel mas_makeConstraints:^(MASConstraintMaker *make) {
    ...
    [_titleEightLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.trailing.equalTo(self).offset(-10);
        make.top.mas_equalTo(self.mas_top).offset(10);
        make.left.mas_equalTo(_detailOneLabel.mas_right).offset(10);
