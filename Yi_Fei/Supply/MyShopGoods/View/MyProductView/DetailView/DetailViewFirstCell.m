...
@implementation DetailViewFirstCell
...
- (void)setShopObjc:(shopData *)shopObjc{
    
    _shopObjc = shopObjc;
    _leftParamLabelOne.text = shopObjc.companyID;
    _leftParamLabelTwo.text = shopObjc.shopSize;
    _leftParamLabelThree.text = @"2016-11-22";
    _rightParamLabelOne.text = shopObjc.shopMed;
    _rightParamLabelTwo.text = shopObjc.shopColor;
    _rightParamLabelThree.text = shopObjc.shopTiaoK;
    _contentLabel.text = shopObjc.shopDescribe;
}
